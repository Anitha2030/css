...
while numGuess != number: # checking the condition until the entered number is 4 and terminate the loop
   numGuess = int(input("Incorrect\nGuess a number between 1 and 10 : "))
print(f"You guessed {numGuess} is correct") # changed the incorrect to correct to make it right comment
