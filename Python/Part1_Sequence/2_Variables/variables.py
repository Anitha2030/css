...
# A variable -- that can be measured and that can assume different values. ........

"Object references 1"
var_num = "an_object/value"  #  var_num is now a name referencing the object "an_object"
...
"What is the function of the object's type when used in a print as shown below?"
print(type(num1))
print(type(num4))
print(type(name))

"This is what happens when you create a variable in python?"
# 1. Creates an int/float/string object (variable)
...
name, address, interest = "Anitha", "Orpington", "cooking/Gardening"
print(name, address, interest)


# "Chained assignment" -- EG:FAMILY NAME
first_child = second_child = third_child = "Anitha"
print(
...
# Chained assignment is assign the same value to multiple variables in one line.
# Multiple values to multiple variables is assign different values to multiple variables.
...
"Research:" 
"To DO: Investigate how python use or make use of constants to answer if there is any similarity with constant use in JavaScript?"
