...
"Syntax :  varName = openMethod('pathtofolPython/Part7_Dict_DataFiles/1_FileHandling_ReadWriteStartFiles/file1.txtder/parthtofile/Part7_Dict_DataFiles/fileName.txt', 'w')"
filePath1 = open("Python/Part7_Dict_DataFiles/1_FileHandling_ReadWriteStartFiles/file1.txt", "w") # folder/folder/filename
...
filePath2 = open("Python/Part7_Dict_DataFiles/1_FileHandling_ReadWriteStartFiles/YourName.txt", "w") # folder/folder/filename
filePath2.write("Anitha Natarajan")
filePath2.close()
