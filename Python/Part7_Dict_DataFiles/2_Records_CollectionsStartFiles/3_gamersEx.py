...
# ask for user input respectively
    ...
    pPass = input("Enter the Player Pass : ")
    pScore = int( input("Enter the Player Score : "))
    pHscore = int(input("Enter the Player High Score : "))
...
with open("Python/Part7_Dict_DataFiles/1_FileHandling_ReadWriteStartFiles/YourName.txt", "a") as file1Path:
